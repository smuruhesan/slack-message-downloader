...
* **Browser:** Use a web-based browser (Chrome, Edge, or Enterprise Browser).
...
* **`CHANNEL_ID`:** The exact system ID for the chat room you want to extract.
  * *How to find it:* In Slack, click on the **Channel Name** at the top-left of the chat window. A details pop-up will appear. Click the **About** tab, scroll to the very bottom, and click the "Copy" icon next to the Channel ID (e.g., `C0B3ZDH5E74`).
* **`START_DATE` & `END_DATE`:** The exact timeframe you want to extract. It must be in `YYYY-MM-DD` format. 

Once you have entered your details, your script configuration should look something like this filled-out example:
